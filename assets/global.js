...
document.querySelectorAll('[id^="Details-"] summary').forEach((summary) => {
  ...
  summary.addEventListener('click', (event) => {
    ...
    if(!event.currentTarget.closest('details').hasAttribute('open')) {
      event.currentTarget.closest('div').classList.add('opened');
    }else{
      event.currentTarget.closest('div').classList.remove('opened');
    }
      ...
      fetch(this.dataset.url)
          ...
          .then(text => {
            ...
            if( view <= '767'){
              ...
              $('.recommended-mobile-slider').slick({
                slidesToShow: 1,
                slidesToScroll: 1,
                variableWidth:true,
                arrows: false,
...
var summary_btn = document.querySelectorAll('.summary');

document.querySelectorAll('.summary').forEach((summary_btn) => {

summary_btn.addEventListener('click', (ev) => {

  ev.currentTarget.parentElement.classList.toggle('open');
  ev.currentTarget.closest('div').classList.toggle('opened');
  ev.currentTarget.nextElementSibling.classList.toggle('active');

});
});

// var summary_desc = document.querySelectorAll('.accordion_content');

// document.querySelectorAll('.summary').forEach((summary_btn) => {
//   summary_btn.addEventListener('click', function (evs) {
// evs.preventDefault();

// if (!summary_desc.classList.contains('active')) {
//   summary_desc.classList.add('active');
//   summary_desc.style.height = 'auto';

//     let height = summary_desc.clientHeight + "px";

//     summary_desc.style.height = '0px';

//     setTimeout(function () {
//       summary_desc.style.height = height;
//     }, 0);
// } else {
//   summary_desc.style.height = '0px';

//   summary_desc.addEventListener('transitionend', function () {
//     summary_desc.classList.remove('active');
//     }, {
//         once: true
//     });
// }
...
//   $('summary.header__menu-item').not(this).parent('.mega-menu').removeClass('active');
